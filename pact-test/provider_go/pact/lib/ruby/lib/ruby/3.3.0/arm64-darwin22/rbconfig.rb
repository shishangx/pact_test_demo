...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/3.3.0/arm64-darwin22")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/tmp/ruby-3.3.3-arm64/inst")
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/tmp/ruby-3.3.3-arm64/inst"
